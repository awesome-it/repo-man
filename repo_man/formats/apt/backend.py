"""APT format backend for the format registry."""
...
class AptBackend:
    """Backend used by registry for format='apt'."""
    ...
    def prune_upstream(
        ...
        return apt_cache.prune_upstream(storage, upstream_id, keep_versions_per_package)
